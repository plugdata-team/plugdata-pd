...
EXTERN int scalar_doclick(t_word *data, t_template *tmpl, t_scalar *sc,
...
void template_notifyforscalar(t_template *tmpl, t_glist *owner,
...
EXTERN int drawtext_gettype(t_gobj *z, t_template *tmpl, int *onsetp);
